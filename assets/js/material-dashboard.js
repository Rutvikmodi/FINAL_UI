...
md = {
  ...
  initDashboardPageCharts: function() {
    ...
    if ($('#dailySalesChart3').length != 0) {
      ...
      var websiteViewsChart = Chartist.Bar('#dailySalesChart3', dataWebsiteViewsChart, optionsWebsiteViewsChart, responsiveOptions);
      ...
      md.startAnimationForBarChart(websiteViewsChart);
        ...
        if ($('#dailySalesChart6').length != 0) {
          ...
          var websiteViewsChart = Chartist.Bar('#dailySalesChart6', dataWebsiteViewsChart, optionsWebsiteViewsChart, responsiveOptions);
          ...
          md.startAnimationForBarChart(websiteViewsChart);
            ...
            if ($('#dailySalesChart9').length != 0) {
              ...
              var websiteViewsChart = Chartist.Bar('#dailySalesChart9', dataWebsiteViewsChart, optionsWebsiteViewsChart, responsiveOptions);
              ...
              md.startAnimationForBarChart(websiteViewsChart);
                ...
                if ($('#dailySalesChart12').length != 0) {
                  ...
                  var websiteViewsChart = Chartist.Bar('#dailySalesChart12', dataWebsiteViewsChart, optionsWebsiteViewsChart, responsiveOptions);
